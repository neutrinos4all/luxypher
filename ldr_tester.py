...
# This is the file for homework 2. I split the reader and writer functions up into their respective files for demonstrative purposes, and included LDR.out as my sample data file.
...
filename = "ldr_test_readings.out"
f = open(filename,"w")
...
print "Light data has been successfully gathered, refer to ldr_test_readings.out for details." # this is another debug statement
